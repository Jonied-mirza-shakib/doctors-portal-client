...
const MyAppoinment = () => {
    ...
    useEffect(() => {
        if (user) {
            fetch(`https://doctors-portal-server-git-main-jonied-mirza-shakib.vercel.app/booking?patient=${user.email}`, {
                method: 'GET',
                headers: {
    ...
    return (
        <div>
            <h1 className='text-center text-purple-800 my-10 font-bold text-2xl'>my appointment</h1>
